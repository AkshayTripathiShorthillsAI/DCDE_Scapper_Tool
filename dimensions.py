...
def process_dimension_text(long_text):
    print("Akshay")
    # Define the prompt
    prompt = f'''You have been given a long text. Your task is to extract specific dimensional specifications and convert them into a JSON format. For each attribute listed below, provide the "label" and "desc" using the format shown. Ensure that the extracted data is concise and accurately reflects the information provided in the text.
